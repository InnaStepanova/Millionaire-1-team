...
Игра "Кто хочет стать миллионером?" - это конкурс викторина, в котором участники должны правильно ответить на ряд вопросов с несколькими вариантами ответов, чтобы перейти на следующий уровень. Всего 15 вопросов, каждый вопрос стоит определенной суммы денег, участники имеют 30 секунд для предоставления ответа. Если участники не успевают ответить, игра заканчивается и участники получают либо несгораемую сумму, либо 0. Участники также получают три вида подсказок, чтобы помочь себе, если они застряли на конкретном вопросе.
...
Задать вопрос аудитории - залу задают тот же вопрос, что и участнику. Показывается всплывающие уведомление где показан самый популярный ответ зала. Участнику дается возможность согласиться с результатами, полученными от аудитории.

Позвоните другу - с определенной вероятностью будет показан правильный ответ.
"""
